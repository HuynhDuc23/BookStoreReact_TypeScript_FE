    ...
    return (
        ...
        <div className="container-fluid">
          ...
          <div className="d-flex">
            <input className="form-control me-2" type="search" placeholder="Tìm kiếm" aria-label="Search" value={tuKhoaTamThoi} onChange={onSearchInputChange} />
            <button className="btn btn-outline-success" type="button">Tìm Kiếm</button>
          </div>
